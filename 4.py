...
day = 0
while day < n and day < len(dataset):  #condition to check if the house with earliest deadline is available within n days
    list_house.append((dataset[day].deadline(), dataset[day])) #n
    day += 1
